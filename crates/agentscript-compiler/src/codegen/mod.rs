...
//! checked by [`wasm::abi::validate_guest_abi_v1`] (and [`validate_guest_abi_v0`] alias).
//!
...
pub use wasm::abi::{
    validate_guest_abi_v0, validate_guest_abi_v1, AbiValidationError, GuestAbiV0, GuestAbiV1,
    GUEST_ABI_V0_EXPORTS, GUEST_ABI_V0_IMPORTS,
};
