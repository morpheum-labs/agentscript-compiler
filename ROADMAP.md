...
- [ ] **Close the gap vs `spec/agentscripts-v1.md`:** matrix / **map literals** (Pine typically uses `matrix.new` / `map.new`; literal forms if any), **`type` / `enum`**, and remaining spec EBNF—audit when `spec/agentscripts-v1.md` is in-tree.
